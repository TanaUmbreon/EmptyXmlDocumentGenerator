...
{
    /// <summary>
    /// public class WheredGenericClass&lt;T&gt; where T : struct
    /// </summary>
    /// <typeparam name="T">where T : struct</typeparam>
    public class WheredGenericClass<T> where T : struct
    {
        ...
        /// <summary>private T? nullableField</summary>
        private T? nullableField;
        ...
        /// <summary>
        /// public WheredGenericClass()
        /// </summary>
        public WheredGenericClass() { }

        /// <summary>
        /// public WheredGenericClass(T arg1)
        /// </summary>
        /// <param name="arg1">T arg1</param>
        public WheredGenericClass(T arg1) { }

        /// <summary>
        /// private WheredGenericClass(string arg1)
        /// </summary>
